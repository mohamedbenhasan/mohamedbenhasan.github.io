      ...
      for (const edge of graphNode.edges) {
        ...
        for (const incident of activeIncidents) {
          ...
          if (distToIncident < 50) { // Penalize if within 50 meters
            ...
            if (incident.severity === IncidentSeverity.HIGH) severityMultiplier = 10;
            else if (incident.severity === IncidentSeverity.MEDIUM) severityMultiplier = 5;
            
            // Exponential decay based on distance
            incidentPenalty += (50 - distToIncident) * severityMultiplier * this.riskWeight;
          }
        }
