...
export const TripRoomPanel: React.FC<TripRoomPanelProps> = ({
  ...
  return (
    <div className="absolute top-16 left-4 z-[1000] w-80 h-[600px] max-h-[80vh] bg-slate-900/95 backdrop-blur-md border border-slate-700 rounded-xl shadow-2xl flex flex-col overflow-hidden">
      {/* Header */}
