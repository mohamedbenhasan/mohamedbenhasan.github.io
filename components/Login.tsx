...
export const Login: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/popup-closed-by-user' || err.code === 'auth/popup-blocked' || err.code === 'auth/unauthorized-domain') {
        setError('Google Sign-In was blocked by your browser. Please ensure popups are enabled and try again.');
      } else {
  ...
  return (
    <div className="min-h-[100vh] bg-slate-950 flex items-center justify-center p-4 relative overflow-y-auto overflow-x-hidden">
      {/* Background Effects */}
