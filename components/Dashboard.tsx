...
import { ThumbsUp, ThumbsDown, Flag, MessageSquare, X, Navigation, Clock, Route as RouteIcon, Shield, ChevronUp, Zap, Bell, BellOff, ThermometerSun, Users, AlertTriangle, Target, Link as LinkIcon } from 'lucide-react';
...
export const Dashboard: React.FC<Props> = ({ user, onLogout, onViewHistory, onViewProfile, onMessages, onZoneSafety, onParentalTracking }) => {
  ...
  useEffect(() => {
    ...
    import('../services/VoiceAssistantService').then(({ voiceAssistantService }) => {
             ...
             <div className="space-y-3">
               ...
               {layerVisibility.riskField && (
                 <div className="flex items-center gap-2 pl-6 mt-1">
                    <span className="text-[10px] text-slate-500">Opacité</span>
                    <input 
                      type="range" 
                      min="0.1" 
                      max="1" 
