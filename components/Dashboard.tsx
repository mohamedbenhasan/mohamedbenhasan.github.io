...
import { ThumbsUp, ThumbsDown, Flag, MessageSquare, X, Navigation, Clock, Route as RouteIcon, Shield, ChevronUp, Zap, Bell, BellOff, ThermometerSun } from 'lucide-react';
