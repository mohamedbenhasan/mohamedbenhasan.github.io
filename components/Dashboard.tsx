...
import { ThumbsUp, ThumbsDown, Flag, MessageSquare, X, Navigation, Clock, Route as RouteIcon, Shield, ChevronUp, Zap, Bell, BellOff } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden w-full">
        ...
        <div className="flex-1 p-4 md:p-6 grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-2 gap-4 md:gap-6 overflow-y-auto lg:overflow-hidden">
          ...
          <div className="col-span-1 lg:col-span-2 lg:row-span-2 relative min-h-[500px] lg:min-h-0 h-[60vh] lg:h-auto glass-panel rounded-2xl overflow-hidden shadow-2xl">
             <MapVisualization state={state} dynamicZoom={dynamicZoom} layerVisibility={layerVisibility} nearbyUsers={nearbyUsers} activeAlerts={activeAlerts} denmMessages={denmMessages} onDestinationChange={handleDestinationChange} />
             
             {/* Unified Navigation Panel */}
             <div className="absolute top-4 right-4 z-[1000] flex flex-col items-end gap-2 w-[calc(100%-2rem)] max-w-sm">
               {!isNavPanelVisible ? (
                 <button 
                   onClick={(e) => {
                     e.stopPropagation();
