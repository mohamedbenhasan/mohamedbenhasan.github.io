...
export const UserProfile: React.FC<Props> = ({ user, onBack, onTrustedContacts, onSosSettings }) => {
  ...
  return (
    <div className="min-h-[100vh] bg-slate-950 text-white p-6 overflow-y-auto">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 text-center">
              ...
              <div className="border-t border-slate-800 pt-6 mt-6 space-y-3">
                ...
                <button 
                  ...
                  className="w-full bg-red-900/20 hover:bg-red-900/40 text-red-100 font-medium py-3 rounded-xl border border-red-500/30 flex items-center justify-center gap-2 transition-colors"
                >
