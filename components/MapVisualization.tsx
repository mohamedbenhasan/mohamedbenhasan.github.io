...
export const MapVisualization: React.FC<Props> = ({ state, dynamicZoom, layerVisibility, nearbyUsers = [], activeAlerts = [], denmMessages = [], onDestinationChange, searchedLocation }) => {
