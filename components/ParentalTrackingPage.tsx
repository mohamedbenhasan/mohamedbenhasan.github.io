...
export const ParentalTrackingPage: React.FC<Props> = ({ onBack }) => {
  ...
  const formatAgo = (dateStr: string | number) => {
  ...
  return (
    <div className="min-h-[100vh] w-full bg-slate-950 flex flex-col font-sans">
      ...
      <div className="flex flex-1 overflow-hidden relative flex-col md:flex-row">
        ...
        {/* Sidebar / List */}
        <div className="w-full md:w-80 bg-slate-900 border-r border-slate-800 flex flex-col shrink-0 z-10 md:h-full h-auto">
        ...
        <div className="flex-1 relative flex flex-col h-[60dvh] md:h-auto min-h-[400px]">
          {activeLink && activeLink.status === 'active' && activeLink.childId ? (
             <>
               ...
               {/* Alerts Panel */}
               <div className="absolute right-4 top-4 bottom-4 w-72 bg-slate-900/95 backdrop-blur shadow-2xl border border-slate-700 rounded-xl z-[400] flex flex-col overflow-hidden transition-transform">
                  ...
                  <div className="flex-1 overflow-y-auto p-2 space-y-2">
                    {childAlerts.length === 0 ? (
                      ...
                      childAlerts.map(alert => (
                        <div key={alert.id} className="p-2.5 bg-slate-800/50 border border-slate-700/50 rounded-lg">
            ...
            <div className="h-full flex-1 flex flex-col items-center justify-center text-center p-6 bg-slate-900/50">
